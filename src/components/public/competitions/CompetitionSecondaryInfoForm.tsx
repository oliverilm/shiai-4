...
const CompetitionSecondaryInfoForm: React.FC<Props> = ({
  setStartDate,
  startDate,
  setEndDate,
  endDate,
  ...
  const handleRegistrationEndChange = (
    e: React.ChangeEvent<HTMLTextAreaElement | HTMLInputElement>,
  ) => {
    ...
    <Main>
      <Center>
        ...
        <Col>
          ...
          <Row>
            <Col>
              <FormLabel style={{ marginBottom: '.2em' }}>
                Competition location
              </FormLabel>
              <div style={{ zIndex: 100 }}>
                <GooglePlacesAutocomplete apiKey="AIzaSyBRaksqElnSQ7FwfhsPjkkxc8FFA8qGUuM" />
              </div>
            </Col>
          </Row>
          <Row>
